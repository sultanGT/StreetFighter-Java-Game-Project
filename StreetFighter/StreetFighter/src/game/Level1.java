...
public class Level1 extends GameLevel {
    ...
    public void populate(Game game) {
        ...
        Body Platform3Size = new StaticBody(this, Platform3Shape);
        Platform3Size.addImage(new BodyImage("data/grassplatform.png", 15f));
        Platform3Size.setPosition(new Vec2(0, 10f));

        for (int i = 0; i < NUM_ORANGES; i++) {
            Body orange = new Turkey(this);
            orange.setPosition(new Vec2(i * 4 - 8, 10));
